...
export default [
  {
    ...
    "config": {
      "themeColors": {
        "c-primary": "rgb(24, 24, 27)",
        "c-primary-dark-100": "rgb(22,22,24)",
        "c-primary-dark-100-alpha-100": "rgba(22, 22, 24, 0.90)",
        "c-primary-alpha-100": "rgba(24, 24, 27, 0.90)",
        "c-primary-dark-100-alpha-200": "rgba(22, 22, 24, 0.80)",
        "c-primary-alpha-200": "rgba(24, 24, 27, 0.80)",
        "c-primary-dark-100-alpha-300": "rgba(22, 22, 24, 0.70)",
        "c-primary-alpha-300": "rgba(24, 24, 27, 0.70)",
        "c-primary-dark-100-alpha-400": "rgba(22, 22, 24, 0.60)",
        "c-primary-alpha-400": "rgba(24, 24, 27, 0.60)",
        "c-primary-dark-100-alpha-500": "rgba(22, 22, 24, 0.50)",
        "c-primary-alpha-500": "rgba(24, 24, 27, 0.50)",
        "c-primary-dark-100-alpha-600": "rgba(22, 22, 24, 0.40)",
        "c-primary-alpha-600": "rgba(24, 24, 27, 0.40)",
        "c-primary-dark-100-alpha-700": "rgba(22, 22, 24, 0.30)",
        "c-primary-alpha-700": "rgba(24, 24, 27, 0.30)",
        "c-primary-dark-100-alpha-800": "rgba(22, 22, 24, 0.20)",
        "c-primary-alpha-800": "rgba(24, 24, 27, 0.20)",
        "c-primary-dark-100-alpha-900": "rgba(22, 22, 24, 0.10)",
        "c-primary-alpha-900": "rgba(24, 24, 27, 0.10)",
        "c-primary-dark-200": "rgb(20,20,22)",
        "c-primary-dark-200-alpha-100": "rgba(20, 20, 22, 0.90)",
        "c-primary-dark-200-alpha-200": "rgba(20, 20, 22, 0.80)",
        "c-primary-dark-200-alpha-300": "rgba(20, 20, 22, 0.70)",
        "c-primary-dark-200-alpha-400": "rgba(20, 20, 22, 0.60)",
        "c-primary-dark-200-alpha-500": "rgba(20, 20, 22, 0.50)",
        "c-primary-dark-200-alpha-600": "rgba(20, 20, 22, 0.40)",
        "c-primary-dark-200-alpha-700": "rgba(20, 20, 22, 0.30)",
        "c-primary-dark-200-alpha-800": "rgba(20, 20, 22, 0.20)",
        "c-primary-dark-200-alpha-900": "rgba(20, 20, 22, 0.10)",
        "c-primary-dark-300": "rgb(18,18,20)",
        "c-primary-dark-300-alpha-100": "rgba(18, 18, 20, 0.90)",
        "c-primary-dark-300-alpha-200": "rgba(18, 18, 20, 0.80)",
        "c-primary-dark-300-alpha-300": "rgba(18, 18, 20, 0.70)",
        "c-primary-dark-300-alpha-400": "rgba(18, 18, 20, 0.60)",
        "c-primary-dark-300-alpha-500": "rgba(18, 18, 20, 0.50)",
        "c-primary-dark-300-alpha-600": "rgba(18, 18, 20, 0.40)",
        "c-primary-dark-300-alpha-700": "rgba(18, 18, 20, 0.30)",
        "c-primary-dark-300-alpha-800": "rgba(18, 18, 20, 0.20)",
        "c-primary-dark-300-alpha-900": "rgba(18, 18, 20, 0.10)",
        "c-primary-dark-400": "rgb(16,16,18)",
        "c-primary-dark-400-alpha-100": "rgba(16, 16, 18, 0.90)",
        "c-primary-dark-400-alpha-200": "rgba(16, 16, 18, 0.80)",
        "c-primary-dark-400-alpha-300": "rgba(16, 16, 18, 0.70)",
        "c-primary-dark-400-alpha-400": "rgba(16, 16, 18, 0.60)",
        "c-primary-dark-400-alpha-500": "rgba(16, 16, 18, 0.50)",
        "c-primary-dark-400-alpha-600": "rgba(16, 16, 18, 0.40)",
        "c-primary-dark-400-alpha-700": "rgba(16, 16, 18, 0.30)",
        "c-primary-dark-400-alpha-800": "rgba(16, 16, 18, 0.20)",
        "c-primary-dark-400-alpha-900": "rgba(16, 16, 18, 0.10)",
        "c-primary-dark-500": "rgb(14,14,16)",
        "c-primary-dark-500-alpha-100": "rgba(14, 14, 16, 0.90)",
        "c-primary-dark-500-alpha-200": "rgba(14, 14, 16, 0.80)",
        "c-primary-dark-500-alpha-300": "rgba(14, 14, 16, 0.70)",
        "c-primary-dark-500-alpha-400": "rgba(14, 14, 16, 0.60)",
        "c-primary-dark-500-alpha-500": "rgba(14, 14, 16, 0.50)",
        "c-primary-dark-500-alpha-600": "rgba(14, 14, 16, 0.40)",
        "c-primary-dark-500-alpha-700": "rgba(14, 14, 16, 0.30)",
        "c-primary-dark-500-alpha-800": "rgba(14, 14, 16, 0.20)",
        "c-primary-dark-500-alpha-900": "rgba(14, 14, 16, 0.10)",
        "c-primary-dark-600": "rgb(13,13,14)",
        "c-primary-dark-600-alpha-100": "rgba(13, 13, 14, 0.90)",
        "c-primary-dark-600-alpha-200": "rgba(13, 13, 14, 0.80)",
        "c-primary-dark-600-alpha-300": "rgba(13, 13, 14, 0.70)",
        "c-primary-dark-600-alpha-400": "rgba(13, 13, 14, 0.60)",
        "c-primary-dark-600-alpha-500": "rgba(13, 13, 14, 0.50)",
        "c-primary-dark-600-alpha-600": "rgba(13, 13, 14, 0.40)",
        "c-primary-dark-600-alpha-700": "rgba(13, 13, 14, 0.30)",
        "c-primary-dark-600-alpha-800": "rgba(13, 13, 14, 0.20)",
        "c-primary-dark-600-alpha-900": "rgba(13, 13, 14, 0.10)",
        "c-primary-dark-700": "rgb(12,12,13)",
        "c-primary-dark-700-alpha-100": "rgba(12, 12, 13, 0.90)",
        "c-primary-dark-700-alpha-200": "rgba(12, 12, 13, 0.80)",
        "c-primary-dark-700-alpha-300": "rgba(12, 12, 13, 0.70)",
        "c-primary-dark-700-alpha-400": "rgba(12, 12, 13, 0.60)",
        "c-primary-dark-700-alpha-500": "rgba(12, 12, 13, 0.50)",
        "c-primary-dark-700-alpha-600": "rgba(12, 12, 13, 0.40)",
        "c-primary-dark-700-alpha-700": "rgba(12, 12, 13, 0.30)",
        "c-primary-dark-700-alpha-800": "rgba(12, 12, 13, 0.20)",
        "c-primary-dark-700-alpha-900": "rgba(12, 12, 13, 0.10)",
        "c-primary-dark-800": "rgb(11,11,12)",
        "c-primary-dark-800-alpha-100": "rgba(11, 11, 12, 0.90)",
        "c-primary-dark-800-alpha-200": "rgba(11, 11, 12, 0.80)",
        "c-primary-dark-800-alpha-300": "rgba(11, 11, 12, 0.70)",
        "c-primary-dark-800-alpha-400": "rgba(11, 11, 12, 0.60)",
        "c-primary-dark-800-alpha-500": "rgba(11, 11, 12, 0.50)",
        "c-primary-dark-800-alpha-600": "rgba(11, 11, 12, 0.40)",
        "c-primary-dark-800-alpha-700": "rgba(11, 11, 12, 0.30)",
        "c-primary-dark-800-alpha-800": "rgba(11, 11, 12, 0.20)",
        "c-primary-dark-800-alpha-900": "rgba(11, 11, 12, 0.10)",
        "c-primary-dark-900": "rgb(10,10,11)",
        "c-primary-dark-900-alpha-100": "rgba(10, 10, 11, 0.90)",
        "c-primary-dark-900-alpha-200": "rgba(10, 10, 11, 0.80)",
        "c-primary-dark-900-alpha-300": "rgba(10, 10, 11, 0.70)",
        "c-primary-dark-900-alpha-400": "rgba(10, 10, 11, 0.60)",
        "c-primary-dark-900-alpha-500": "rgba(10, 10, 11, 0.50)",
        "c-primary-dark-900-alpha-600": "rgba(10, 10, 11, 0.40)",
        "c-primary-dark-900-alpha-700": "rgba(10, 10, 11, 0.30)",
        "c-primary-dark-900-alpha-800": "rgba(10, 10, 11, 0.20)",
        "c-primary-dark-900-alpha-900": "rgba(10, 10, 11, 0.10)",
        "c-primary-dark-1000": "rgb(9,9,10)",
        "c-primary-dark-1000-alpha-100": "rgba(9, 9, 10, 0.90)",
        "c-primary-dark-1000-alpha-200": "rgba(9, 9, 10, 0.80)",
        "c-primary-dark-1000-alpha-300": "rgba(9, 9, 10, 0.70)",
        "c-primary-dark-1000-alpha-400": "rgba(9, 9, 10, 0.60)",
        "c-primary-dark-1000-alpha-500": "rgba(9, 9, 10, 0.50)",
        "c-primary-dark-1000-alpha-600": "rgba(9, 9, 10, 0.40)",
        "c-primary-dark-1000-alpha-700": "rgba(9, 9, 10, 0.30)",
        "c-primary-dark-1000-alpha-800": "rgba(9, 9, 10, 0.20)",
        "c-primary-dark-1000-alpha-900": "rgba(9, 9, 10, 0.10)",
        "c-primary-light-100": "rgb(70,70,73)",
        "c-primary-light-100-alpha-100": "rgba(70, 70, 73, 0.90)",
        "c-primary-light-100-alpha-200": "rgba(70, 70, 73, 0.80)",
        "c-primary-light-100-alpha-300": "rgba(70, 70, 73, 0.70)",
        "c-primary-light-100-alpha-400": "rgba(70, 70, 73, 0.60)",
        "c-primary-light-100-alpha-500": "rgba(70, 70, 73, 0.50)",
        "c-primary-light-100-alpha-600": "rgba(70, 70, 73, 0.40)",
        "c-primary-light-100-alpha-700": "rgba(70, 70, 73, 0.30)",
        "c-primary-light-100-alpha-800": "rgba(70, 70, 73, 0.20)",
        "c-primary-light-100-alpha-900": "rgba(70, 70, 73, 0.10)",
        "c-primary-light-200": "rgb(107,107,109)",
        "c-primary-light-200-alpha-100": "rgba(107, 107, 109, 0.90)",
        "c-primary-light-200-alpha-200": "rgba(107, 107, 109, 0.80)",
        "c-primary-light-200-alpha-300": "rgba(107, 107, 109, 0.70)",
        "c-primary-light-200-alpha-400": "rgba(107, 107, 109, 0.60)",
        "c-primary-light-200-alpha-500": "rgba(107, 107, 109, 0.50)",
        "c-primary-light-200-alpha-600": "rgba(107, 107, 109, 0.40)",
        "c-primary-light-200-alpha-700": "rgba(107, 107, 109, 0.30)",
        "c-primary-light-200-alpha-800": "rgba(107, 107, 109, 0.20)",
        "c-primary-light-200-alpha-900": "rgba(107, 107, 109, 0.10)",
        "c-primary-light-300": "rgb(137,137,138)",
        "c-primary-light-300-alpha-100": "rgba(137, 137, 138, 0.90)",
        "c-primary-light-300-alpha-200": "rgba(137, 137, 138, 0.80)",
        "c-primary-light-300-alpha-300": "rgba(137, 137, 138, 0.70)",
        "c-primary-light-300-alpha-400": "rgba(137, 137, 138, 0.60)",
        "c-primary-light-300-alpha-500": "rgba(137, 137, 138, 0.50)",
        "c-primary-light-300-alpha-600": "rgba(137, 137, 138, 0.40)",
        "c-primary-light-300-alpha-700": "rgba(137, 137, 138, 0.30)",
        "c-primary-light-300-alpha-800": "rgba(137, 137, 138, 0.20)",
        "c-primary-light-300-alpha-900": "rgba(137, 137, 138, 0.10)",
        "c-primary-light-400": "rgb(161,161,161)",
        "c-primary-light-400-alpha-100": "rgba(161, 161, 161, 0.90)",
        "c-primary-light-400-alpha-200": "rgba(161, 161, 161, 0.80)",
        "c-primary-light-400-alpha-300": "rgba(161, 161, 161, 0.70)",
        "c-primary-light-400-alpha-400": "rgba(161, 161, 161, 0.60)",
        "c-primary-light-400-alpha-500": "rgba(161, 161, 161, 0.50)",
        "c-primary-light-400-alpha-600": "rgba(161, 161, 161, 0.40)",
        "c-primary-light-400-alpha-700": "rgba(161, 161, 161, 0.30)",
        "c-primary-light-400-alpha-800": "rgba(161, 161, 161, 0.20)",
        "c-primary-light-400-alpha-900": "rgba(161, 161, 161, 0.10)",
        "c-primary-light-500": "rgb(180,180,180)",
        "c-primary-light-500-alpha-100": "rgba(180, 180, 180, 0.90)",
        "c-primary-light-500-alpha-200": "rgba(180, 180, 180, 0.80)",
        "c-primary-light-500-alpha-300": "rgba(180, 180, 180, 0.70)",
        "c-primary-light-500-alpha-400": "rgba(180, 180, 180, 0.60)",
        "c-primary-light-500-alpha-500": "rgba(180, 180, 180, 0.50)",
        "c-primary-light-500-alpha-600": "rgba(180, 180, 180, 0.40)",
        "c-primary-light-500-alpha-700": "rgba(180, 180, 180, 0.30)",
        "c-primary-light-500-alpha-800": "rgba(180, 180, 180, 0.20)",
        "c-primary-light-500-alpha-900": "rgba(180, 180, 180, 0.10)",
        "c-primary-light-600": "rgb(195,195,195)",
        "c-primary-light-600-alpha-100": "rgba(195, 195, 195, 0.90)",
        "c-primary-light-600-alpha-200": "rgba(195, 195, 195, 0.80)",
        "c-primary-light-600-alpha-300": "rgba(195, 195, 195, 0.70)",
        "c-primary-light-600-alpha-400": "rgba(195, 195, 195, 0.60)",
        "c-primary-light-600-alpha-500": "rgba(195, 195, 195, 0.50)",
        "c-primary-light-600-alpha-600": "rgba(195, 195, 195, 0.40)",
        "c-primary-light-600-alpha-700": "rgba(195, 195, 195, 0.30)",
        "c-primary-light-600-alpha-800": "rgba(195, 195, 195, 0.20)",
        "c-primary-light-600-alpha-900": "rgba(195, 195, 195, 0.10)",
        "c-primary-light-700": "rgb(207,207,207)",
        "c-primary-light-700-alpha-100": "rgba(207, 207, 207, 0.90)",
        "c-primary-light-700-alpha-200": "rgba(207, 207, 207, 0.80)",
        "c-primary-light-700-alpha-300": "rgba(207, 207, 207, 0.70)",
        "c-primary-light-700-alpha-400": "rgba(207, 207, 207, 0.60)",
        "c-primary-light-700-alpha-500": "rgba(207, 207, 207, 0.50)",
        "c-primary-light-700-alpha-600": "rgba(207, 207, 207, 0.40)",
        "c-primary-light-700-alpha-700": "rgba(207, 207, 207, 0.30)",
        "c-primary-light-700-alpha-800": "rgba(207, 207, 207, 0.20)",
        "c-primary-light-700-alpha-900": "rgba(207, 207, 207, 0.10)",
        "c-primary-light-800": "rgb(217,217,217)",
        "c-primary-light-800-alpha-100": "rgba(217, 217, 217, 0.90)",
        "c-primary-light-800-alpha-200": "rgba(217, 217, 217, 0.80)",
        "c-primary-light-800-alpha-300": "rgba(217, 217, 217, 0.70)",
        "c-primary-light-800-alpha-400": "rgba(217, 217, 217, 0.60)",
        "c-primary-light-800-alpha-500": "rgba(217, 217, 217, 0.50)",
        "c-primary-light-800-alpha-600": "rgba(217, 217, 217, 0.40)",
        "c-primary-light-800-alpha-700": "rgba(217, 217, 217, 0.30)",
        "c-primary-light-800-alpha-800": "rgba(217, 217, 217, 0.20)",
        "c-primary-light-800-alpha-900": "rgba(217, 217, 217, 0.10)",
        "c-primary-light-900": "rgb(225,225,225)",
        "c-primary-light-900-alpha-100": "rgba(225, 225, 225, 0.90)",
        "c-primary-light-900-alpha-200": "rgba(225, 225, 225, 0.80)",
        "c-primary-light-900-alpha-300": "rgba(225, 225, 225, 0.70)",
        "c-primary-light-900-alpha-400": "rgba(225, 225, 225, 0.60)",
        "c-primary-light-900-alpha-500": "rgba(225, 225, 225, 0.50)",
        "c-primary-light-900-alpha-600": "rgba(225, 225, 225, 0.40)",
        "c-primary-light-900-alpha-700": "rgba(225, 225, 225, 0.30)",
        "c-primary-light-900-alpha-800": "rgba(225, 225, 225, 0.20)",
        "c-primary-light-900-alpha-900": "rgba(225, 225, 225, 0.10)",
        ...
        "c-700": "rgb(83,83,84)",
        "c-650": "rgb(95,95,96)",
        "c-600": "rgb(107,107,109)",
        "c-550": "rgb(120,120,121)",
        "c-500": "rgb(132,132,133)",
        "c-450": "rgb(144,144,145)",
        "c-400": "rgb(157,157,157)",
        "c-350": "rgb(169,169,170)",
        "c-300": "rgb(181,181,182)",
        "c-250": "rgb(194,194,194)",
        "c-200": "rgb(206,206,206)",
        "c-150": "rgb(218,218,218)",
        "c-100": "rgb(230,230,231)",
