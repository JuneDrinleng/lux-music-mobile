...
public class MusicModule extends ReactContextBaseJavaModule implements ServiceConnection {
    ...
    public Map<String, Object> getConstants() {
        ...
        constants.put("CAPABILITY_LIKE", Utils.CAPABILITY_LIKE);
    ...
    @ReactMethod
    public void isCached(String url, @Nullable String cacheKey, final Promise callback) {
        waitForConnection(() -> {
            binder.getPlayback().isCached(url, cacheKey, callback);
        });
    }
